...
export default function Register() {
    ...
    return (
        <div style={{
            ...
            <div className="card-glass shadow-2xl" style={{ width: '100%', maxWidth: '480px', padding: 'var(--space-8)', zIndex: 1 }}>
                ...
                <p className="text-center mt-8" style={{ fontSize: '14px', color: 'var(--text-dim)' }}>
